...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-md-12">
	 ...
	 <tr>
	  ...
	  <tr>
	     ...
	     <td><?php echo e($prof->cin); ?></td>
	     <td><?php echo e($prof->nom); ?></td>
	     <td><?php echo e($prof->prenom); ?></td>
	     <td><?php echo e($prof->sexe); ?></td>  
		  <td><?php echo e($prof->tel); ?></td>
	     <td><?php echo e($prof->email); ?></td>
		 <td><?php echo e($prof->depart); ?></td>
	    <td>
		 <a href="<?php echo e(route('profs.edit',$prof->id)); ?>" class="btn btn-warning" ><i class="fa fa-edit"></i></a>
		  <form action="<?php echo e(route('profs.destroy',$prof->id)); ?>" method="post">
		<?php echo csrf_field(); ?>
	...
	<div class="modal fade" id="addProf" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" >
      ...
      <div class="modal-body">
	    <form action="<?php echo e(route('profs.store')); ?>"  method="post" enctype="multipart/form-data">
		<?php echo csrf_field(); ?>
		<div class="container">
         <div class="row my-5">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GestionEnsei\resources\views/admins/index.blade.php ENDPATH**/ ?>